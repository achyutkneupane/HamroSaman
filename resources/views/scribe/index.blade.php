...
<head>
    ...
    <title>HamroSaman API Docs</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                        ...
                        <a href="#endpoints-POSTapi-login">Authenticate the user</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-register">
                        <a href="#endpoints-POSTapi-register">Register the User</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-reset-password">
                        <a href="#endpoints-POSTapi-reset-password">Reset the password</a>
                    </li>
                                                    </ul>
                            </ul>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
            ...
            <h2 id="endpoints-POSTapi-login">Authenticate the user</h2>
...
<p>Must be at least 8 characters.</p>
            ...
            <h2 id="endpoints-POSTapi-register">Register the User</h2>
...
<p>Must be at least 8 characters.</p>
            ...
            <h2 id="endpoints-POSTapi-reset-password">Reset the password</h2>
